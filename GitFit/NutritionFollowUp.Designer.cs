namespace GitFit
{
    partial class NutritionQuestionnaireFollowUp
    {
        ...
        private void InitializeComponent()
        {
            ...
            // answersPanel
            // 
            this.answersPanel.Controls.Add(this.answer9ComboBox);
            this.answersPanel.Controls.Add(this.answer1ComboBox);
            this.answersPanel.Controls.Add(this.answer8ComboBox);
            this.answersPanel.Controls.Add(this.answer2ComboBox);
            this.answersPanel.Controls.Add(this.answer7ComboBox);
            this.answersPanel.Controls.Add(this.answer3ComboBox);
